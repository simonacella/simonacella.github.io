# Guida file (senza CMS)

Sito: https://simonacella.github.io/

**Via principale:** [README.md](./README.md) — pubblica gli articoli dal modulo in `/admin`, senza aprire i file.

Questa pagina è solo se ti serve modificare i file a mano (bio, contatti, titolo del sito, o un articolo già sul repository). Non serve saper programmare: bastano gli esempi qui sotto, copiati e adattati con attenzione.
